<template>
  <div class="logistics-registration-container">
    <div class="registration-header">
      ...
      <button @click="$router.push('/admin/logistics')" class="btn-list-link">목록으로 돌아가기</button>
    </div>
...
.header-left h1 { font-size: 1.75rem; font-weight: 700; color: #0f172a; margin-bottom: 0.5rem; }
...
.btn-list-link:hover { background: #f8fafc; color: #0f172a; }
...
.type-btn.active { background: white; color: #0f172a; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1); }
...
.form-section.divider { border-top: 1px solid #f1f5f9; padding-top: 2.5rem; }
...
.form-group input:focus, .form-group select:focus { border-color: #0f172a; box-shadow: 0 0 0 4px rgba(15, 23, 42, 0.05); }
